...
function CCP() {
  ...
  async function processChatText(content, type, contactId) {
    ...
    console.log(languageTranslate, content, textLang, translatedMessage);
    console.log(
    ...
    let data2 = {
      ...
      username: "customer",
      content: <p>{content}</p>,
      translatedMessage: <p>{translatedMessage.TranslatedText}</p>,
    };
    ...
    if (window.connect.ChatSession) {
      ...
      window.connect.contact((contact) => {
        ...
        contact.onAccepted(async () => {
          ...
          console.log(localLanguageTranslate);
          if (
  ...
  return (
    <main>
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <div id="ccp-container" style={{ width: 380, height: 825 }}></div>
